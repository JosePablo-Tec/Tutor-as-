...
//        }
    ...
    private void jBtnGenerarTablerosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnGenerarTablerosActionPerformed
       ...
       // jTxaImpresion.setText(proyecto1.toString());//QUE HACE ESTA
...
//-------------------------------- Mostrar y Tachar Los Números Generados --------------------------------// 
    ...
    Object selectedValue = jCboElegirTableros.getSelectedItem();
    ...
    if (selectedValue != null && selectedValue instanceof Integer) {
        ...
        switch (posicion) {
            case 0:
                jTxaImpresion.setText(proyecto1.tableroToString(index-1000));
                break;
            case 1:
                jTxaImpresion.setText(proyecto1.tableroToStringQuinario(index-1000));
                break;
            case 2:
                jTxaImpresion.setText(proyecto1.tableroToStringOctal(index-1000));
                break;
            case 3:
                jTxaImpresion.setText(proyecto1.tableroToStringDuodecimal(index-1000));
                break;
            case 4:
                jTxaImpresion.setText(proyecto1.tableroToStringHexadecimal(index-1000));
                break;
            default:
                break;
        }
        ...
        // Manejar el caso en el que el valor seleccionado no es un entero
...
//-------------------------------- Elegir Modo de Juego --------------------------------//  
        ...
        switch (modoJuego) {
            case "Cartón Lleno":
                if (ganador) {
                    int[] ganadores=proyecto1.getGanadores();
                    List<Integer> ganadoresParseados = new ArrayList<>();

                    // Iterar sobre el array original y agregar a la nueva lista si no es 0
                    for (int elem : ganadores) {
                        if (elem != 0) {
                            ganadoresParseados.add(elem);
                        }
                    }
                    JOptionPane.showMessageDialog(this, "Ganaste en el modo Cartón Lleno\n"
                            + ganadoresParseados.toString(), "¡Felicidades!", JOptionPane.INFORMATION_MESSAGE, icono);
